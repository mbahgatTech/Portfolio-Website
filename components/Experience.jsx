        ...
        <>
            {
                ...
                <div className='w-5/6 mx-auto'>
                    ...
                    {experiences.map(experience => 
                        <div className='max-w-full my-16 mx-auto bg-white rounded-xl shadow-md overflow-hidden justify-center items-center'>
                            ...
                            <div className="w-[95%] mx-auto justify-center items-center">
                                ...
                                <div className='mt-6 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 justify-center'>     
                                    {experience.techStack.map(elem =>
                                        <div className="max-w-sm rounded overflow-hidden shadow-lg mb-4 mx-auto w-full">
                                            <a href={elem.link}>
