                ...
                <form className='mt-10' onSubmit={event => {
                    ...
                    <div className='grid gap-6 sm:grid-cols-2'>
                        <div className='relative z-0'>
                            <input type='text' name='name' className='peer mt-1 block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0' />
                        ...
                        <div className='relative z-0'>
                            <input type='text' name='email' className='peer block mt-1 w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0' />
                        ...
                        <div className='relative z-0 col-span-2'>
                            <textarea name='message' rows='5' className='peer mt-1 block w-full appearance-none border-0 border-b border-gray-500 bg-transparent py-2.5 px-0 text-sm text-white focus:border-blue-600 focus:outline-none focus:ring-0'></textarea>
