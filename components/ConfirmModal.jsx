...
const Modal = ({ visible, setModal }) => {
    return (
        <div className={(!visible) ? 'hidden' : 'visible' + 'overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 md:inset-0 h-modal md:h-full justify-center items-center flex'}>
            <div className='relative p-4 w-full max-w-md h-full md:h-auto'>
                <div className='relative bg-white rounded-lg shadow dark:bg-gray-700'>
                    ...
                    <div className='p-6 text-center'>
                        ...
                        <button onClick={() => {
                            setModal(false);
                            MessageSubmit({name: 'Mazen', email: 'emda', message: 'dsdada'});
